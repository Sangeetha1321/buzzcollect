...
<?php endif; ?>
    <head>
		...
		<link href="<?php echo base_url();?>styles/fSelect.css" rel="stylesheet" type="text/css">
		...
		<script src="<?php echo base_url();?>scripts/libraries/highcharts/highcharts.js"></script>
		<script src="<?php echo base_url();?>scripts/libraries/highcharts/funnel.js"></script>
		<script src="<?php echo base_url();?>scripts/libraries/highcharts/exporting.js"></script>
		<script src="<?php echo base_url();?>scripts/libraries/highcharts/export-data.js"></script>
		<!-- <link href="<?php echo base_url();?>styles/jquery.multiselect.css" rel="stylesheet" type="text/css">
		<script src="<?php echo base_url();?>scripts/libraries/jquery.multiselect.js"></script> -->
		<script src="<?php echo base_url();?>scripts/libraries/fSelect.js"></script>
	    ...
	    <script type="text/javascript" src="<?php echo base_url() ?>bootstrap/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
	</head>
    <body>
    ...
    <nav class="navbar navbar-inverse navbar-header2">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand-two" href="<?php echo site_url() ?>" title="<?php echo $this->settings->info->site_name ?>"><img src="<?php echo base_url() ?><?php echo $this->settings->info->upload_path_relative ?>/<?php echo $this->settings->info->site_logo ?>" width="200" height="60"></a>
        <?php else : ?>
		...
		<!--
			...
			-->
            <li class="home_icon">
			<a href="<?php echo site_url() ?>"><span class="glyphicon glyphicon-home"></span><?php echo "  Home";  ?></a>
			</li>
            <li class="user_bit">
			...
			<span class="glyphicon glyphicon-user"></span><?php echo ' '.$this->user->info->username ?>
			<!-- </a> -->
			</li>
			<li><a href="<?php echo site_url("login/logout/" . $this->security->get_csrf_hash()) ?>"><span class="glyphicon glyphicon-log-out"></span><?php echo ' '.lang("ctn_149") ?></a></li>
          <?php else : ?>
...
<button type="button" id="sidebarCollapse" class="navbar-btn">
    ...
    <div id="footer" class="clearfix">
      <span class="pull-left">
		<?php echo lang("ctn_170") ?> 
		<a id="spi_global" target="_blank" title="SPi Global" href="https://www.spi-global.com/">SPi Global</a> - <?php echo $this->settings->info->site_name ?> - <!-- <?php echo $this->settings->version ?> -->
	    <strong>Copyright &copy; <?php echo date("Y"); ?></strong>
	  </span> 
	  <span class="pull-right">
		<!-- <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a> 
		<strong>Copyright &copy; <?php echo date("Y"); ?> - <a title="SPi Global" href="https://www.spi-global.com/">SPi Global</a></strong> -->
	  </span>
    </div>
