...
<?php endif; ?>
    <head>
        ...
        <link href="<?php echo base_url();?>bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet" media="screen">
        
         <!-- Styles -->
        <link href="<?php echo base_url();?>styles/layouts/titan_rtl/main.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url();?>styles/layouts/titan_rtl/responsive.css" rel="stylesheet" type="text/css">
