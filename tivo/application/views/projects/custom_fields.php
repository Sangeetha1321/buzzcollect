...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo lang("ctn_946"); ?></button>
</div>
</div>
...
<?php foreach($fields->result() as $r) : ?>
  ...
  ?>
<tr><td><?php echo $r->name ?></td><td><?php echo $type ?></td><td><a href="<?php echo site_url("projects/edit_custom_field/" . $r->ID) ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="<?php echo lang("ctn_55") ?>"><span class="glyphicon glyphicon-cog"></span></a> <a href="<?php echo site_url("projects/delete_custom_field/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" onclick="return confirm('<?php echo lang("ctn_317") ?>')" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang("ctn_714"); ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open(site_url("projects/add_custom_field"), array("class" => "form-horizontal")) ?>
