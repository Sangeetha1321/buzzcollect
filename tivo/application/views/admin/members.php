				...
				<div class="form-group">
					...
					<select name="langOptgroup[]" multiple id="langOptgroup">
						...
						<optgroup label="<?php echo $r->skills ?>">
							<option value="<?php echo $r->skills.'-Average'; ?>">Average</option>
							<option value="<?php echo $r->skills.'-Good'; ?>">Good</option>
							<option value="<?php echo $r->skills.'-Excellent'; ?>">Excellent</option>
						</optgroup>
						<?php endforeach; ?>
					</select> 
					</div>
