...
<div class="form-group">
	...
	<?php
		...
		foreach($target as $tar){
			$arr[] = rtrim($tar,"Average Good Excellent");
		} 
		...
		foreach ($skillSets as $needle)
		{
			$fulltext = '';
			foreach($target as $t){
			if(rtrim($t,"Average Good Excellent") == $needle.'-'){
				if(rtrim($t,"Average") == $needle.'-'){
					$fulltext = $needle.'-Average';
				} elseif(rtrim($t,"Good") == $needle.'-'){
					$fulltext = $needle.'-Good';
				} elseif(rtrim($t,"Excellent") == $needle.'-'){
					$fulltext = $needle.'-Excellent';
				} else{
					$fulltext = '';
				}
			}
			} ?>
			<optgroup label="<?php echo $needle ?>">
			<option value="<?php echo $needle.'-Average'; ?>" <?php if($fulltext == $needle.'-Average'){echo 'selected="selected"';} ?>>Average</option>
			<option value="<?php echo $needle.'-Good'; ?>" <?php if($fulltext == $needle.'-Good'){echo 'selected="selected"';} ?>>Good</option>
			<option value="<?php echo $needle.'-Excellent'; ?>" <?php if($fulltext == $needle.'-Excellent'){echo 'selected="selected"';}?>>Excellent</option>
			</optgroup>
		<?php } 
	?>
    </select>
