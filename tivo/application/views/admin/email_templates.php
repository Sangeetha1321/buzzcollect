...
<input type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal" value="Add Email Template">
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_11") ?></td><td><?php echo lang("ctn_1299") ?></td><td><?php echo lang("ctn_148") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-send"></span> <?php echo lang("ctn_1300") ?></h4>
      </div>
      <div class="modal-body">
         <?php echo form_open(site_url("admin/add_email_template"), array("class" => "form-horizontal")) ?>
          <div class="form-group">
            ...
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1299") ?></label>
                    <div class="col-md-8">
                        <select name="hook" class="form-control">
                        <option value="email_activation"><?php echo lang("ctn_1301") ?></option>
                        <option value="forgot_password"><?php echo lang("ctn_174") ?></option>
                        <option value="ticket_reply"><?php echo lang("ctn_1302") ?></option>
                        <option value="ticket_creation"><?php echo lang("ctn_1303") ?></option>
                        <option value="ordered_service"><?php echo lang("ctn_1304") ?></option>
                        <option value="invoice_reminder"><?php echo lang("ctn_1417") ?></option>
                        <option value="invoice_overdue"><?php echo lang("ctn_1418") ?></option>
                        <option value="new_notification"><?php echo lang("ctn_1419") ?></option>
                        <option value="tasks_overdue"><?php echo "Tasks Overdue"; ?></option>
                        </select>
                        <span class="help-block"><?php echo lang("ctn_1305") ?></span>
                    </div>
            </div>
            <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_1300") ?>">
        <?php echo form_close() ?>
      </div>
    </div>
  </div>
