...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_1127") ?></label>
    <div class="col-sm-10">
        <select name="logo_option" class="form-control">
        <option value="0"><?php echo lang("ctn_1128") ?></option>
        <option value="1" <?php if($this->settings->info->logo_option) echo "selected" ?>><?php echo lang("ctn_1129") ?></option>
        </select>
        <span class="help-block"><?php echo lang("ctn_92") ?></span>
    </div>
</div>
...
<div class="form-group">
    <label for="se-in" class="col-sm-2 control-label"><?php echo lang("ctn_1274") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1423") ?></label>
    <div class="col-sm-5">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1424") ?></label>
    <div class="col-sm-10">
        ...
        <span class="help-block"><?php echo lang("ctn_1425") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_331") ?></label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="dpname-in" name="fp_currency_symbol" placeholder="" value="<?php echo $this->settings->info->fp_currency_symbol ?>" ><br />
        <span class="help-block"><?php echo lang("ctn_332") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_333") ?></label>
    <div class="col-sm-10">
        ...
        <span class="help-block"><?php echo lang("ctn_334") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1275") ?></label>
    <div class="col-sm-10">
        <select name="client_user_role" class="form-control">
        <?php foreach($roles->result() as $r) : ?>
            <option value="<?php echo $r->ID ?>" <?php if($r->ID == $this->settings->info->client_user_role) echo "selected" ?>><?php echo $r->name ?></option>
        <?php endforeach; ?>  
        </select>
        <span class="help-block"><?php echo lang("ctn_1276") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="cachetime-in" class="col-sm-2 control-label"><?php echo lang("ctn_1277") ?></label>
    <div class="col-sm-10">
        <input type="text" class="form-control" id="cachetime-in" name="cache_time" placeholder="" value="<?php echo $this->settings->info->cache_time ?>" ><br />
        <span class="help-block"><?php echo lang("ctn_1278") ?></span>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1130") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="google_recaptcha" value="1" <?php if($this->settings->info->google_recaptcha) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_1131") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1132") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1133") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_335") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="disable_ticket_upload" value="1" <?php if($this->settings->info->disable_ticket_upload) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_336") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_337") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="login_protect" value="1" <?php if($this->settings->info->login_protect) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_338") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_339") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="activate_account" value="1" <?php if($this->settings->info->activate_account) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_340") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1125") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="secure_login" value="1" <?php if($this->settings->info->secure_login) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_1126") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1279") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="profile_comments" value="1" <?php if($this->settings->info->profile_comments) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_1280") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1522") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="doc_view_all" value="1" <?php if($this->settings->info->doc_view_all) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_1523") ?></span>
    </div>
</div>
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1524") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="dashboard_services" value="1" <?php if($this->settings->info->dashboard_services) echo "checked" ?> />
        <span class="help-block"><?php echo lang("ctn_1525") ?></span>
    </div>
</div>
