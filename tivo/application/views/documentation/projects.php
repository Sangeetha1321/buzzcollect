...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra form-inline"> 
      ...
      <a href="<?php echo site_url("client/documentation") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_1537") ?></a>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_734") ?></td><td><?php echo lang("ctn_81") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#cat-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("documentation/project_page") ?>",
            type : 'GET',
            data : function ( d ) {
