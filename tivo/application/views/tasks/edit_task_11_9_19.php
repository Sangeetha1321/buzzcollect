...
<div class="panel-body">
 ...
 <?php echo form_open(site_url("tasks/edit_task_pro/" . $task->ID), array("class" => "form-horizontal")) ?>
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="unitPricePerArticle" value="<?php echo $task->unitPricePerArticle ?>" id="unitPricePerArticle" >
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1595") ?></label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="totalArticles" value="<?php echo $task->totalArticles ?>" id="totalArticles">
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1597") ?></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="totalArticlesPrice" value="<?php echo $task->totalArticlesPrice ?>" id="totalArticlesPrice" readonly >
                    </div>
            </div>
			</div>
			<div id="table">
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="unitPricePerImage" value="<?php echo $task->unitPricePerImage ?>" id="unitPricePerImage" >
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Total Images"; ?></label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="totalImages" value="<?php echo $task->totalImages ?>" id="totalImages">
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Revenue: Images"; ?></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="totalImagesPrice" value="<?php echo $task->totalImagesPrice ?>" id="totalImagesPrice" readonly >
                    </div>
            </div>
			</div>
            <div class="form-group">
         ...
         "task_manage"), 
			...
			<!-- <div class="form-group">
				<label for="p-in" class="col-md-4 label-heading"><?php echo "Chapter(s)"; ?></label>
				<div class="col-md-8">
				<input type="checkbox" name="chapters" id="chapters" value="1" <?php /* if($task->chapters) echo "checked" */ ?>/>
				<span class="help-text">Chapter(s)</span>
				</div>
            </div>
			<div id="chapters_list">
				<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input id="chapter_name" type="text" class="form-control" name="chapter_name" value="<?php /* echo $task->chapter_name */ ?>">
                    </div>
				</div>
			</div>	-->
