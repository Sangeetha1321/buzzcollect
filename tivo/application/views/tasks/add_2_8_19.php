...
<div class="panel-body">
 ...
 <?php echo form_open(site_url("tasks/add_task_process"), array("class" => "form-horizontal")) ?>
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="unitPricePerArticle" value="" id="unitPricePerArticle" >
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_1595") ?></label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="totalArticles" value="" id="totalArticles">
                    </div>
            </div>
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="totalArticlesPrice" value="" id="totalArticlesPrice" readonly >
                    </div>
            </div>
			</div>
			<div id="table">
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="unitPricePerImage" value="" id="unitPricePerImage" >
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Total Images"; ?></label>
                    <div class="col-md-8">
                        <input type="number" class="form-control" name="totalImages" value="" id="totalImages">
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Revenue: Images"; ?></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="totalImagesPrice" value="" id="totalImagesPrice" readonly >
                    </div>
            </div>
			</div>
            <div class="form-group">
