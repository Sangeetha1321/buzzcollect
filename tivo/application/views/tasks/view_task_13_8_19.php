...
<div class="col-md-8">
	<div class="white-area-content">
		...
		<p class="project-info-bit"><?php echo $task->unitPricePerArticle ?></p>
		</div>
		<div class="project-info project-block">
		<p class="project-info-title"><?php echo lang("ctn_1595") ?></p>
		<p class="project-info-bit"><?php echo $task->totalArticles ?></p>
		</div>
		<div class="project-info project-block">
		<p class="project-info-title"><?php echo lang("ctn_1597") ?></p>
		<p class="project-info-bit"><?php echo $geo_total = $task->totalArticlesPrice ?></p>
		</div>
		<?php } ?>
		...
		<p class="project-info-bit"><?php echo $task->unitPricePerImage ?></p>
		</div>
		<div class="project-info project-block">
		<p class="project-info-title"><?php echo "Total Images"; ?></p>
		<p class="project-info-bit"><?php echo $task->totalImages ?></p>
		</div>
		<div class="project-info project-block">
		<p class="project-info-title"><?php echo "Revenue: Images"; ?></p>
		<p class="project-info-bit"><?php echo $geo_total = $task->totalImagesPrice ?></p>
		</div>
		<?php } ?>
