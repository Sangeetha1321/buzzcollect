...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-folder-open"></span> <?php if($page == "clients") : ?><?php echo lang("ctn_1469") ?><?php else : ?><?php echo lang("ctn_132") ?><?php endif; ?></div>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_357") ?></td><td><?php echo lang("ctn_322") ?></td><td><?php echo lang("ctn_689") ?></td><td><?php echo lang("ctn_761") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#team-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("team/user_page/" . $page) ?>",
            type : 'GET',
            data : function ( d ) {
