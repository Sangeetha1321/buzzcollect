...
<div class="panel-body">
 ...
 <?php echo form_open_multipart(site_url("files/add_file_process"), array("class" => "form-horizontal","autocomplete" => "off")) ?>
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
						...
						<?php foreach($projects->result() as $pr) :
						if($default_projectid == $pr->ID){
						?>
						<input type="hidden" name="project_name" value="<?php echo $pr->name; ?>">
						<?php 
						}
						endforeach; ?>
                    </div>
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="format_used" value="" id="format_used">
                    </div>
            </div>
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Broadcast Day Start Time"; ?></label>
                    <div class="col-md-8">
                        <input type="time" class="form-control" name="broadcast_day_st_time" value="" id="broadcast_day_st_time">
                    </div>
            </div> 
			<!--
			<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "Team Name"; ?></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="team_name" value="" id="team_name">
                    </div>
            </div> 
			-->
			<div class="form-group">
			...
			<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="name" value="" id="filenom">
                    </div>
            </div>
            <!-- <div class="form-group">
			...
			<div id="display_cal">
				<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control form_datetime" name="st_date" value="" id="st_date">
                    </div>
				</div>
				<!--
				<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="time" class="form-control" name="st_time" value="" id="st_time">
                    </div>
				</div> -->
				<div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo "End Date"; ?></label>
                    <div class="col-md-8">
                        <input type="text" class="form-control form_datetime" name="end_date" value="" id="end_date">
                    </div>
				</div> 
				<!--
				<div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="time" class="form-control" name="end_time" value="" id="end_time">
					</div>
				</div> -->
			</div>
            <div class="form-group">
			...
			-->
            <input type="submit" class="btn btn-primary form-control" value="<?php echo "Add File"; ?>" />
	...
	$('#project-select').change(function() {
    	$.ajax({
	        ...
	        success: function(data) {
				...
				/* $('#format_used').attr('value', data.format_used); */
